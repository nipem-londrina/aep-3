 ...
 * @author Mateus
 */
public class TelaCadastroResposta extends javax.swing.JFrame {


    public TelaCadastroResposta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnCadastrarResposta, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, 150, 40));
        ...
        jPanel1.add(cbxIdPergunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 120, 140, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 120, 140, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroResposta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroResposta().setVisible(true);
            }
        });
    }
