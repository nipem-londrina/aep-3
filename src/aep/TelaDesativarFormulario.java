 ...
 * @author Mateus
 */
public class TelaDesativarFormulario extends javax.swing.JFrame {


    public TelaDesativarFormulario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDesativarFormulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDesativarFormulario().setVisible(true);
            }
        });
    }
